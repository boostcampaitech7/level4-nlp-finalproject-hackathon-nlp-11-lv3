...
def main(cfg: DictConfig):
    ...
    if cfg.mode == "retrieve":
        ...
        # JSON 파일 경로 설정
        text_json_path = "../../PDF_OCR/new_data/text.json"
        table_json_path = "../../PDF_OCR/new_data/table.json"
        ...
        try:
            ...
            # 처리된 파일 이동
            vector_store.move_to_old_data([text_json_path, table_json_path], old_data_dir="../../PDF_OCR/old_data")
            print("벡터 DB 업데이트 완료")
